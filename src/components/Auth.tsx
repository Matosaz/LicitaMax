...
export default function Auth() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://licitamaxbackend.onrender.com/api/auth/register", {
        method: "POST",
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://licitamaxbackend.onrender.com/api/auth/login", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
